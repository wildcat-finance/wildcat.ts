...
export enum SetAprStatus {
  ...
  NoPendingAprChange = "NoPendingAprChange",
...
export enum QueueWithdrawalStatus {
  ...
  OutsideWithdrawalWindow = "OutsideWithdrawalWindow",
  RequiresAccess = "RequiresAccess"
}
...
export type ProposeAnnualInterestBipsPreview = {
  status: ProposeAnnualInterestBipsStatus;
};
