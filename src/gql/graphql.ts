...
export type SubgraphArchController = {
  ...
  borrowers: Array<SubgraphRegisteredBorrower>;
...
export type SubgraphController = {
  ...
  authorizationChanges: Array<SubgraphLenderAuthorizationChange>;
  authorizedLenders: Array<SubgraphLenderAuthorization>;
...
export type SubgraphLenderAccount = {
  ...
  id: Scalars['ID']['output'];
  interestAccrualRecords: Array<SubgraphLenderInterestAccrued>;
  ...
  withdrawals: Array<SubgraphLenderWithdrawalStatus>;
};
...
export type SubgraphLenderAccount_Filter = {
  ...
  role_in?: InputMaybe<Array<SubgraphLenderStatus>>;
  role_not?: InputMaybe<SubgraphLenderStatus>;
  role_not_in?: InputMaybe<Array<SubgraphLenderStatus>>;
...
export type SubgraphLenderAuthorization = {
  ...
  changes: Array<SubgraphLenderAuthorizationChange>;
  controller: SubgraphController;
  id: Scalars['ID']['output'];
  lender: Scalars['Bytes']['output'];
  marketAccounts: Array<SubgraphLenderAccount>;
};
...
export type SubgraphMarket = {
  ...
  archController: SubgraphArchController;
  asset: SubgraphToken;
  borrowRecords: Array<SubgraphBorrow>;
  borrower: Scalars['Bytes']['output'];
  controller: SubgraphController;
  ...
  depositRecords: Array<SubgraphDeposit>;
  feeCollectionRecords: Array<SubgraphFeesCollected>;
  feeRecipient: Scalars['Bytes']['output'];
  id: Scalars['ID']['output'];
  interestAccrualRecords: Array<SubgraphMarketInterestAccrued>;
  isClosed: Scalars['Boolean']['output'];
  isDelinquent: Scalars['Boolean']['output'];
  isRegistered: Scalars['Boolean']['output'];
  lastInterestAccruedTimestamp: Scalars['Int']['output'];
  lenders: Array<SubgraphLenderAccount>;
...
export type SubgraphQuery = {
  ...
  parameterConstraints: Array<SubgraphParameterConstraints>;
...
export type SubgraphRegisteredBorrower = {
  ...
  archController: SubgraphArchController;
  borrower: Scalars['Bytes']['output'];
  changes: Array<SubgraphBorrowerRegistrationChange>;
  id: Scalars['ID']['output'];
  isRegistered: Scalars['Boolean']['output'];
};
...
export type SubgraphSubscriptionSanctionedAccountWithdrawalSentToEscrowArgs = SubgraphQueryApprovalArgs;
...
export type SubgraphWithdrawalBatch = {
  ...
  expiry: Scalars['BigInt']['output'];
  id: Scalars['ID']['output'];
  interestAccrualRecords: Array<SubgraphWithdrawalBatchInterestAccrued>;
  isClosed: Scalars['Boolean']['output'];
...
export type SubgraphAccountDataForLenderViewFragment = { __typename?: 'LenderAccount', id: string, address: string, scaledBalance: string, role: SubgraphLenderStatus, totalDeposited: string, lastScaleFactor: string, lastUpdatedTimestamp: number, totalInterestEarned: string, numPendingWithdrawalBatches: number, controllerAuthorization: { __typename?: 'LenderAuthorization', authorized: boolean }, deposits: Array<SubgraphDepositDataFragment> };
...
export type SubgraphGetLenderAccountForMarketQuery = { __typename?: 'Query', market?: { __typename?: 'Market', lenders: Array<SubgraphAccountDataForLenderViewFragment> } | null };
...
export type SubgraphGetAccountsWhereLenderAuthorizedOrActiveQuery = { __typename?: 'Query', lenderAccounts: Array<{ __typename?: 'LenderAccount', id: string, address: string, scaledBalance: string, role: SubgraphLenderStatus, totalDeposited: string, lastScaleFactor: string, lastUpdatedTimestamp: number, totalInterestEarned: string, numPendingWithdrawalBatches: number, market: SubgraphMarketDataFragment, controllerAuthorization: { __typename?: 'LenderAuthorization', authorized: boolean }, deposits: Array<SubgraphDepositDataFragment> }> };
...
export type SubgraphGetLenderWithdrawalsForMarketQuery = { __typename?: 'Query', market?: { __typename?: 'Market', lenders: Array<{ __typename?: 'LenderAccount', incompleteWithdrawals: Array<SubgraphLenderWithdrawalPropertiesWithEventsFragment>, completeWithdrawals: Array<SubgraphLenderWithdrawalPropertiesWithEventsFragment> }> } | null };
...
export type SubgraphGetLenderAuthorizationByMarketQuery = { __typename?: 'Query', market?: { __typename?: 'Market', controller: { __typename?: 'Controller', authorizedLenders: Array<{ __typename?: 'LenderAuthorization', lender: string, authorized: boolean }> } } | null };
...
export type SubgraphGetMarketsAndLogsWhereLenderAuthorizedOrActiveQuery = { __typename?: 'Query', lenderAccounts: Array<{ __typename?: 'LenderAccount', scaledBalance: string, role: SubgraphLenderStatus, totalDeposited: string, lastScaleFactor: string, totalInterestEarned: string, market: { __typename?: 'Market', id: string }, controllerAuthorization: { __typename?: 'LenderAuthorization', authorized: boolean }, withdrawals: Array<{ __typename?: 'LenderWithdrawalStatus', id: string, requestsCount: number, executionsCount: number, scaledAmount: string, normalizedAmountWithdrawn: string, totalNormalizedRequests: string, isCompleted: boolean, batch: SubgraphWithdrawalBatchPropertiesFragment, requests: Array<SubgraphWithdrawalRequestPropertiesFragment>, executions: Array<SubgraphWithdrawalExecutionPropertiesFragment>, account: { __typename?: 'LenderAccount', address: string } }>, deposits: Array<SubgraphDepositDataFragment> }> };
...
export type SubgraphGetMarketsForBorrowerQuery = { __typename?: 'Query', controllers: Array<{ __typename?: 'Controller', markets: Array<SubgraphMarketDataFragment> }> };
...
export type SubgraphGetAllPendingWithdrawalBatchesForMarketQuery = { __typename?: 'Query', market?: { __typename?: 'Market', withdrawalBatches: Array<SubgraphWithdrawalBatchPropertiesWithEventsFragment> } | null };

export type SubgraphGetAllMarketsQueryVariables = Exact<{ [key: string]: never; }>;


export type SubgraphGetAllMarketsQuery = { __typename?: 'Query', markets: Array<SubgraphMarketDataFragment> };
...
export type SubgraphGetAuthorizedLendersByMarketQuery = { __typename?: 'Query', market?: { __typename?: 'Market', controller: { __typename?: 'Controller', authorizedLenders: Array<{ __typename?: 'LenderAuthorization', lender: string }> } } | null };
...
export type SubgraphGetAuthorizedLendersByBorrowerQuery = { __typename?: 'Query', controllers: Array<{ __typename?: 'Controller', authorizedLenders: Array<{ __typename?: 'LenderAuthorization', lender: string }> }> };

export type SubgraphGetSubgraphStatusQueryVariables = Exact<{ [key: string]: never; }>;


export type SubgraphGetSubgraphStatusQuery = { __typename?: 'Query', _meta?: { __typename?: '_Meta_', hasIndexingErrors: boolean, block: { __typename?: '_Block_', hash?: string | null, number: number, timestamp?: number | null } } | null };

export type SubgraphLenderPropertiesFragment = { __typename?: 'LenderAccount', id: string, address: string, scaledBalance: string, role: SubgraphLenderStatus, totalDeposited: string, lastScaleFactor: string, lastUpdatedTimestamp: number, totalInterestEarned: string, numPendingWithdrawalBatches: number };

export type SubgraphDepositDataFragment = { __typename?: 'Deposit', id: string, assetAmount: string, scaledAmount: string, blockNumber: number, blockTimestamp: number, transactionHash: string };

export type SubgraphMarketDataFragment = { __typename?: 'Market', id: string, isRegistered: boolean, isClosed: boolean, borrower: string, sentinel: string, feeRecipient: string, name: string, symbol: string, decimals: number, protocolFeeBips: number, delinquencyGracePeriod: number, delinquencyFeeBips: number, withdrawalBatchDuration: number, maxTotalSupply: string, pendingProtocolFees: string, normalizedUnclaimedWithdrawals: string, scaledTotalSupply: string, scaledPendingWithdrawals: string, pendingWithdrawalExpiry: string, isDelinquent: boolean, timeDelinquent: number, annualInterestBips: number, reserveRatioBips: number, scaleFactor: string, lastInterestAccruedTimestamp: number, originalReserveRatioBips: number, temporaryReserveRatioExpiry: number, temporaryReserveRatioActive: boolean, totalBorrowed: string, totalRepaid: string, totalBaseInterestAccrued: string, totalDelinquencyFeesAccrued: string, totalProtocolFeesAccrued: string, totalDeposited: string, controller: { __typename?: 'Controller', id: string }, _asset: { __typename?: 'Token', id: string, address: string, name: string, symbol: string, decimals: number, isMock: boolean } };
...
export type SubgraphWithdrawalRequestPropertiesFragment = { __typename?: 'WithdrawalRequest', id: string, requestIndex: number, scaledAmount: string, normalizedAmount: string, blockNumber: number, blockTimestamp: number, transactionHash: string, account: { __typename?: 'LenderAccount', address: string } };
...
export type SubgraphLenderWithdrawalPropertiesWithEventsFragment = { __typename?: 'LenderWithdrawalStatus', id: string, requestsCount: number, executionsCount: number, scaledAmount: string, normalizedAmountWithdrawn: string, totalNormalizedRequests: string, isCompleted: boolean, batch: SubgraphWithdrawalBatchPropertiesWithEventsFragment, requests: Array<SubgraphWithdrawalRequestPropertiesFragment>, executions: Array<SubgraphWithdrawalExecutionPropertiesFragment>, account: { __typename?: 'LenderAccount', address: string } };

export type SubgraphWithdrawalBatchPropertiesFragment = { __typename?: 'WithdrawalBatch', id: string, expiry: string, scaledTotalAmount: string, scaledAmountBurned: string, normalizedAmountPaid: string, normalizedAmountClaimed: string, totalNormalizedRequests: string, isExpired: boolean, isClosed: boolean, paymentsCount: number, lastScaleFactor: string, lastUpdatedTimestamp: number, totalInterestEarned: string, creation: { __typename?: 'WithdrawalBatchCreated', blockNumber: number, blockTimestamp: number, transactionHash: string }, payments: Array<SubgraphWithdrawalBatchPaymentPropertiesFragment> };

export type SubgraphWithdrawalBatchPropertiesWithEventsFragment = { __typename?: 'WithdrawalBatch', id: string, expiry: string, scaledTotalAmount: string, scaledAmountBurned: string, normalizedAmountPaid: string, normalizedAmountClaimed: string, totalNormalizedRequests: string, isExpired: boolean, isClosed: boolean, paymentsCount: number, lastScaleFactor: string, lastUpdatedTimestamp: number, totalInterestEarned: string, withdrawals: Array<SubgraphLenderWithdrawalPropertiesFragment>, requests: Array<SubgraphWithdrawalRequestPropertiesFragment>, executions: Array<SubgraphWithdrawalExecutionPropertiesFragment>, creation: { __typename?: 'WithdrawalBatchCreated', blockNumber: number, blockTimestamp: number, transactionHash: string }, payments: Array<SubgraphWithdrawalBatchPaymentPropertiesFragment> };
...
export type SubgraphGetMarketRecordsQuery = { __typename?: 'Query', market?: SubgraphMarketRecordsFragment | null };

export type SubgraphMarketRecordsFragment = { __typename?: 'Market', depositRecords: Array<SubgraphDepositDataFragment>, borrowRecords: Array<SubgraphBorrowDataFragment>, feeCollectionRecords: Array<SubgraphFeesCollectedDataFragment>, repaymentRecords: Array<SubgraphRepaymentDataFragment> };

export type SubgraphBorrowDataFragment = { __typename?: 'Borrow', assetAmount: string, blockNumber: number, blockTimestamp: number, transactionHash: string };

export type SubgraphRepaymentDataFragment = { __typename?: 'DebtRepaid', from: string, assetAmount: string, blockNumber: number, blockTimestamp: number, transactionHash: string };

export type SubgraphFeesCollectedDataFragment = { __typename?: 'FeesCollected', feesCollected: string, blockNumber: number, blockTimestamp: number, transactionHash: string };
...
export const GetLenderAccountForMarketDocument = gql`
    query getLenderAccountForMarket($market: ID!, $lender: Bytes!, $numDeposits: Int = 200, $skipDeposits: Int = 0, $orderDeposits: Deposit_orderBy = blockTimestamp, $directionDeposits: OrderDirection = desc, $numWithdrawals: Int = 200, $skipWithdrawals: Int = 0) {
  market(id: $market) {
 ...
 * });
 */
export function useGetLenderAccountForMarketQuery(baseOptions: Apollo.QueryHookOptions<SubgraphGetLenderAccountForMarketQuery, SubgraphGetLenderAccountForMarketQueryVariables>): GetLenderAccountForMarketQueryHookResult {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SubgraphGetLenderAccountForMarketQuery, SubgraphGetLenderAccountForMarketQueryVariables>(GetLenderAccountForMarketDocument, options);
      }
export function useGetLenderAccountForMarketLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SubgraphGetLenderAccountForMarketQuery, SubgraphGetLenderAccountForMarketQueryVariables>): GetLenderAccountForMarketLazyQueryHookResult {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SubgraphGetLenderAccountForMarketQuery, SubgraphGetLenderAccountForMarketQueryVariables>(GetLenderAccountForMarketDocument, options);
        }
export function useGetLenderAccountForMarketSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<SubgraphGetLenderAccountForMarketQuery, SubgraphGetLenderAccountForMarketQueryVariables>): GetLenderAccountForMarketSuspenseQueryHookResult {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<SubgraphGetLenderAccountForMarketQuery, SubgraphGetLenderAccountForMarketQueryVariables>(GetLenderAccountForMarketDocument, options);
        }
...
export const GetAccountsWhereLenderAuthorizedOrActiveDocument = gql`
    query getAccountsWhereLenderAuthorizedOrActive($lender: Bytes!, $numDeposits: Int = 200, $skipDeposits: Int = 0, $orderDeposits: Deposit_orderBy = blockTimestamp, $directionDeposits: OrderDirection = desc, $numWithdrawals: Int = 200, $skipWithdrawals: Int = 0) {
  lenderAccounts(
    where: {and: [{address: $lender}, {or: [{role_in: [DepositAndWithdraw, WithdrawOnly]}, {scaledBalance_gt: 0}, {controllerAuthorization_: {authorized: true}}, {totalDeposited_gt: 0}]}]}
  ) {
    ...AccountDataForLenderView
    market {
      ...MarketData
 ...
 * });
 */
export function useGetAccountsWhereLenderAuthorizedOrActiveQuery(baseOptions: Apollo.QueryHookOptions<SubgraphGetAccountsWhereLenderAuthorizedOrActiveQuery, SubgraphGetAccountsWhereLenderAuthorizedOrActiveQueryVariables>): GetAccountsWhereLenderAuthorizedOrActiveQueryHookResult {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SubgraphGetAccountsWhereLenderAuthorizedOrActiveQuery, SubgraphGetAccountsWhereLenderAuthorizedOrActiveQueryVariables>(GetAccountsWhereLenderAuthorizedOrActiveDocument, options);
      }
export function useGetAccountsWhereLenderAuthorizedOrActiveLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SubgraphGetAccountsWhereLenderAuthorizedOrActiveQuery, SubgraphGetAccountsWhereLenderAuthorizedOrActiveQueryVariables>): GetAccountsWhereLenderAuthorizedOrActiveLazyQueryHookResult {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SubgraphGetAccountsWhereLenderAuthorizedOrActiveQuery, SubgraphGetAccountsWhereLenderAuthorizedOrActiveQueryVariables>(GetAccountsWhereLenderAuthorizedOrActiveDocument, options);
        }
export function useGetAccountsWhereLenderAuthorizedOrActiveSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<SubgraphGetAccountsWhereLenderAuthorizedOrActiveQuery, SubgraphGetAccountsWhereLenderAuthorizedOrActiveQueryVariables>): GetAccountsWhereLenderAuthorizedOrActiveSuspenseQueryHookResult {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<SubgraphGetAccountsWhereLenderAuthorizedOrActiveQuery, SubgraphGetAccountsWhereLenderAuthorizedOrActiveQueryVariables>(GetAccountsWhereLenderAuthorizedOrActiveDocument, options);
        }
 ...
 * });
 */
export function useGetLenderWithdrawalsForMarketQuery(baseOptions: Apollo.QueryHookOptions<SubgraphGetLenderWithdrawalsForMarketQuery, SubgraphGetLenderWithdrawalsForMarketQueryVariables>): GetLenderWithdrawalsForMarketQueryHookResult {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SubgraphGetLenderWithdrawalsForMarketQuery, SubgraphGetLenderWithdrawalsForMarketQueryVariables>(GetLenderWithdrawalsForMarketDocument, options);
      }
export function useGetLenderWithdrawalsForMarketLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SubgraphGetLenderWithdrawalsForMarketQuery, SubgraphGetLenderWithdrawalsForMarketQueryVariables>): GetLenderWithdrawalsForMarketLazyQueryHookResult {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SubgraphGetLenderWithdrawalsForMarketQuery, SubgraphGetLenderWithdrawalsForMarketQueryVariables>(GetLenderWithdrawalsForMarketDocument, options);
        }
export function useGetLenderWithdrawalsForMarketSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<SubgraphGetLenderWithdrawalsForMarketQuery, SubgraphGetLenderWithdrawalsForMarketQueryVariables>): GetLenderWithdrawalsForMarketSuspenseQueryHookResult {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<SubgraphGetLenderWithdrawalsForMarketQuery, SubgraphGetLenderWithdrawalsForMarketQueryVariables>(GetLenderWithdrawalsForMarketDocument, options);
        }
 ...
 * });
 */
export function useGetLenderAuthorizationByMarketQuery(baseOptions: Apollo.QueryHookOptions<SubgraphGetLenderAuthorizationByMarketQuery, SubgraphGetLenderAuthorizationByMarketQueryVariables>): GetLenderAuthorizationByMarketQueryHookResult {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SubgraphGetLenderAuthorizationByMarketQuery, SubgraphGetLenderAuthorizationByMarketQueryVariables>(GetLenderAuthorizationByMarketDocument, options);
      }
export function useGetLenderAuthorizationByMarketLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SubgraphGetLenderAuthorizationByMarketQuery, SubgraphGetLenderAuthorizationByMarketQueryVariables>): GetLenderAuthorizationByMarketLazyQueryHookResult {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SubgraphGetLenderAuthorizationByMarketQuery, SubgraphGetLenderAuthorizationByMarketQueryVariables>(GetLenderAuthorizationByMarketDocument, options);
        }
export function useGetLenderAuthorizationByMarketSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<SubgraphGetLenderAuthorizationByMarketQuery, SubgraphGetLenderAuthorizationByMarketQueryVariables>): GetLenderAuthorizationByMarketSuspenseQueryHookResult {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<SubgraphGetLenderAuthorizationByMarketQuery, SubgraphGetLenderAuthorizationByMarketQueryVariables>(GetLenderAuthorizationByMarketDocument, options);
        }
...
export const GetMarketsAndLogsWhereLenderAuthorizedOrActiveDocument = gql`
    query getMarketsAndLogsWhereLenderAuthorizedOrActive($lender: Bytes!, $minimumBalance: BigInt = 1, $numDeposits: Int = 200, $skipDeposits: Int = 0, $orderDeposits: Deposit_orderBy = blockTimestamp, $directionDeposits: OrderDirection = desc, $numWithdrawals: Int = 200, $skipWithdrawals: Int = 0) {
  lenderAccounts(
    where: {address: $lender, or: [{role_in: [DepositAndWithdraw, WithdrawOnly]}, {scaledBalance_gt: $minimumBalance}, {controllerAuthorization_: {authorized: true}}]}
  ) {
    market {
      id
    }
 ...
 * });
 */
export function useGetMarketsAndLogsWhereLenderAuthorizedOrActiveQuery(baseOptions: Apollo.QueryHookOptions<SubgraphGetMarketsAndLogsWhereLenderAuthorizedOrActiveQuery, SubgraphGetMarketsAndLogsWhereLenderAuthorizedOrActiveQueryVariables>): GetMarketsAndLogsWhereLenderAuthorizedOrActiveQueryHookResult {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SubgraphGetMarketsAndLogsWhereLenderAuthorizedOrActiveQuery, SubgraphGetMarketsAndLogsWhereLenderAuthorizedOrActiveQueryVariables>(GetMarketsAndLogsWhereLenderAuthorizedOrActiveDocument, options);
      }
export function useGetMarketsAndLogsWhereLenderAuthorizedOrActiveLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SubgraphGetMarketsAndLogsWhereLenderAuthorizedOrActiveQuery, SubgraphGetMarketsAndLogsWhereLenderAuthorizedOrActiveQueryVariables>): GetMarketsAndLogsWhereLenderAuthorizedOrActiveLazyQueryHookResult {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SubgraphGetMarketsAndLogsWhereLenderAuthorizedOrActiveQuery, SubgraphGetMarketsAndLogsWhereLenderAuthorizedOrActiveQueryVariables>(GetMarketsAndLogsWhereLenderAuthorizedOrActiveDocument, options);
        }
export function useGetMarketsAndLogsWhereLenderAuthorizedOrActiveSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<SubgraphGetMarketsAndLogsWhereLenderAuthorizedOrActiveQuery, SubgraphGetMarketsAndLogsWhereLenderAuthorizedOrActiveQueryVariables>): GetMarketsAndLogsWhereLenderAuthorizedOrActiveSuspenseQueryHookResult {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<SubgraphGetMarketsAndLogsWhereLenderAuthorizedOrActiveQuery, SubgraphGetMarketsAndLogsWhereLenderAuthorizedOrActiveQueryVariables>(GetMarketsAndLogsWhereLenderAuthorizedOrActiveDocument, options);
        }
 ...
 * });
 */
export function useGetMarketsForBorrowerQuery(baseOptions: Apollo.QueryHookOptions<SubgraphGetMarketsForBorrowerQuery, SubgraphGetMarketsForBorrowerQueryVariables>): GetMarketsForBorrowerQueryHookResult {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SubgraphGetMarketsForBorrowerQuery, SubgraphGetMarketsForBorrowerQueryVariables>(GetMarketsForBorrowerDocument, options);
      }
export function useGetMarketsForBorrowerLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SubgraphGetMarketsForBorrowerQuery, SubgraphGetMarketsForBorrowerQueryVariables>): GetMarketsForBorrowerLazyQueryHookResult {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SubgraphGetMarketsForBorrowerQuery, SubgraphGetMarketsForBorrowerQueryVariables>(GetMarketsForBorrowerDocument, options);
        }
export function useGetMarketsForBorrowerSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<SubgraphGetMarketsForBorrowerQuery, SubgraphGetMarketsForBorrowerQueryVariables>): GetMarketsForBorrowerSuspenseQueryHookResult {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<SubgraphGetMarketsForBorrowerQuery, SubgraphGetMarketsForBorrowerQueryVariables>(GetMarketsForBorrowerDocument, options);
        }
 ...
 * });
 */
export function useGetAllPendingWithdrawalBatchesForMarketQuery(baseOptions: Apollo.QueryHookOptions<SubgraphGetAllPendingWithdrawalBatchesForMarketQuery, SubgraphGetAllPendingWithdrawalBatchesForMarketQueryVariables>): GetAllPendingWithdrawalBatchesForMarketQueryHookResult {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SubgraphGetAllPendingWithdrawalBatchesForMarketQuery, SubgraphGetAllPendingWithdrawalBatchesForMarketQueryVariables>(GetAllPendingWithdrawalBatchesForMarketDocument, options);
      }
export function useGetAllPendingWithdrawalBatchesForMarketLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SubgraphGetAllPendingWithdrawalBatchesForMarketQuery, SubgraphGetAllPendingWithdrawalBatchesForMarketQueryVariables>): GetAllPendingWithdrawalBatchesForMarketLazyQueryHookResult {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SubgraphGetAllPendingWithdrawalBatchesForMarketQuery, SubgraphGetAllPendingWithdrawalBatchesForMarketQueryVariables>(GetAllPendingWithdrawalBatchesForMarketDocument, options);
        }
export function useGetAllPendingWithdrawalBatchesForMarketSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<SubgraphGetAllPendingWithdrawalBatchesForMarketQuery, SubgraphGetAllPendingWithdrawalBatchesForMarketQueryVariables>): GetAllPendingWithdrawalBatchesForMarketSuspenseQueryHookResult {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<SubgraphGetAllPendingWithdrawalBatchesForMarketQuery, SubgraphGetAllPendingWithdrawalBatchesForMarketQueryVariables>(GetAllPendingWithdrawalBatchesForMarketDocument, options);
        }
 ...
 * });
 */
export function useGetAllMarketsQuery(baseOptions?: Apollo.QueryHookOptions<SubgraphGetAllMarketsQuery, SubgraphGetAllMarketsQueryVariables>): GetAllMarketsQueryHookResult {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SubgraphGetAllMarketsQuery, SubgraphGetAllMarketsQueryVariables>(GetAllMarketsDocument, options);
      }
export function useGetAllMarketsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SubgraphGetAllMarketsQuery, SubgraphGetAllMarketsQueryVariables>): GetAllMarketsLazyQueryHookResult {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SubgraphGetAllMarketsQuery, SubgraphGetAllMarketsQueryVariables>(GetAllMarketsDocument, options);
        }
export function useGetAllMarketsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<SubgraphGetAllMarketsQuery, SubgraphGetAllMarketsQueryVariables>): GetAllMarketsSuspenseQueryHookResult {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<SubgraphGetAllMarketsQuery, SubgraphGetAllMarketsQueryVariables>(GetAllMarketsDocument, options);
        }
 ...
 * });
 */
export function useGetAuthorizedLendersByMarketQuery(baseOptions: Apollo.QueryHookOptions<SubgraphGetAuthorizedLendersByMarketQuery, SubgraphGetAuthorizedLendersByMarketQueryVariables>): GetAuthorizedLendersByMarketQueryHookResult {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SubgraphGetAuthorizedLendersByMarketQuery, SubgraphGetAuthorizedLendersByMarketQueryVariables>(GetAuthorizedLendersByMarketDocument, options);
      }
export function useGetAuthorizedLendersByMarketLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SubgraphGetAuthorizedLendersByMarketQuery, SubgraphGetAuthorizedLendersByMarketQueryVariables>): GetAuthorizedLendersByMarketLazyQueryHookResult {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SubgraphGetAuthorizedLendersByMarketQuery, SubgraphGetAuthorizedLendersByMarketQueryVariables>(GetAuthorizedLendersByMarketDocument, options);
        }
export function useGetAuthorizedLendersByMarketSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<SubgraphGetAuthorizedLendersByMarketQuery, SubgraphGetAuthorizedLendersByMarketQueryVariables>): GetAuthorizedLendersByMarketSuspenseQueryHookResult {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<SubgraphGetAuthorizedLendersByMarketQuery, SubgraphGetAuthorizedLendersByMarketQueryVariables>(GetAuthorizedLendersByMarketDocument, options);
        }
 ...
 * });
 */
export function useGetAuthorizedLendersByBorrowerQuery(baseOptions: Apollo.QueryHookOptions<SubgraphGetAuthorizedLendersByBorrowerQuery, SubgraphGetAuthorizedLendersByBorrowerQueryVariables>): GetAuthorizedLendersByBorrowerQueryHookResult {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SubgraphGetAuthorizedLendersByBorrowerQuery, SubgraphGetAuthorizedLendersByBorrowerQueryVariables>(GetAuthorizedLendersByBorrowerDocument, options);
      }
export function useGetAuthorizedLendersByBorrowerLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SubgraphGetAuthorizedLendersByBorrowerQuery, SubgraphGetAuthorizedLendersByBorrowerQueryVariables>): GetAuthorizedLendersByBorrowerLazyQueryHookResult {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SubgraphGetAuthorizedLendersByBorrowerQuery, SubgraphGetAuthorizedLendersByBorrowerQueryVariables>(GetAuthorizedLendersByBorrowerDocument, options);
        }
export function useGetAuthorizedLendersByBorrowerSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<SubgraphGetAuthorizedLendersByBorrowerQuery, SubgraphGetAuthorizedLendersByBorrowerQueryVariables>): GetAuthorizedLendersByBorrowerSuspenseQueryHookResult {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<SubgraphGetAuthorizedLendersByBorrowerQuery, SubgraphGetAuthorizedLendersByBorrowerQueryVariables>(GetAuthorizedLendersByBorrowerDocument, options);
        }
 ...
 * });
 */
export function useGetSubgraphStatusQuery(baseOptions?: Apollo.QueryHookOptions<SubgraphGetSubgraphStatusQuery, SubgraphGetSubgraphStatusQueryVariables>): GetSubgraphStatusQueryHookResult {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SubgraphGetSubgraphStatusQuery, SubgraphGetSubgraphStatusQueryVariables>(GetSubgraphStatusDocument, options);
      }
export function useGetSubgraphStatusLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SubgraphGetSubgraphStatusQuery, SubgraphGetSubgraphStatusQueryVariables>): GetSubgraphStatusLazyQueryHookResult {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SubgraphGetSubgraphStatusQuery, SubgraphGetSubgraphStatusQueryVariables>(GetSubgraphStatusDocument, options);
        }
export function useGetSubgraphStatusSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<SubgraphGetSubgraphStatusQuery, SubgraphGetSubgraphStatusQueryVariables>): GetSubgraphStatusSuspenseQueryHookResult {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<SubgraphGetSubgraphStatusQuery, SubgraphGetSubgraphStatusQueryVariables>(GetSubgraphStatusDocument, options);
        }
...
export const GetMarketRecordsDocument = gql`
    query getMarketRecords($market: ID!, $numDeposits: Int = 10, $skipDeposits: Int = 0, $orderDeposits: Deposit_orderBy = blockTimestamp, $directionDeposits: OrderDirection = desc, $numBorrows: Int = 10, $skipBorrows: Int = 0, $orderBorrows: Borrow_orderBy = blockTimestamp, $directionBorrows: OrderDirection = desc, $numFeeCollections: Int = 10, $skipFeeCollections: Int = 0, $orderFeeCollections: FeesCollected_orderBy = blockTimestamp, $directionFeeCollections: OrderDirection = desc, $numRepayments: Int = 10, $skipRepayments: Int = 0, $orderRepayments: DebtRepaid_orderBy = blockTimestamp, $directionRepayments: OrderDirection = desc) {
  market(id: $market) {
    ...MarketRecords
  }
}
 ...
 * });
 */
export function useGetMarketRecordsQuery(baseOptions: Apollo.QueryHookOptions<SubgraphGetMarketRecordsQuery, SubgraphGetMarketRecordsQueryVariables>): GetMarketRecordsQueryHookResult {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SubgraphGetMarketRecordsQuery, SubgraphGetMarketRecordsQueryVariables>(GetMarketRecordsDocument, options);
      }
export function useGetMarketRecordsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SubgraphGetMarketRecordsQuery, SubgraphGetMarketRecordsQueryVariables>): GetMarketRecordsLazyQueryHookResult {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SubgraphGetMarketRecordsQuery, SubgraphGetMarketRecordsQueryVariables>(GetMarketRecordsDocument, options);
        }
export function useGetMarketRecordsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<SubgraphGetMarketRecordsQuery, SubgraphGetMarketRecordsQueryVariables>): GetMarketRecordsSuspenseQueryHookResult {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<SubgraphGetMarketRecordsQuery, SubgraphGetMarketRecordsQueryVariables>(GetMarketRecordsDocument, options);
        }
