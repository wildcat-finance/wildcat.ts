...
export class WildcatMarket__factory {
  static readonly abi = _abi;
  static createInterface(): WildcatMarketInterface {
    return new utils.Interface(_abi) as WildcatMarketInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): WildcatMarket {
    return new Contract(address, _abi, signerOrProvider) as WildcatMarket;
  }
}
