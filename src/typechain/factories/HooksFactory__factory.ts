...
import type { HooksFactory, HooksFactoryInterface } from "../HooksFactory";
...
export class HooksFactory__factory {
  static readonly abi = _abi;
  static createInterface(): HooksFactoryInterface {
    return new utils.Interface(_abi) as HooksFactoryInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): HooksFactory {
    return new Contract(address, _abi, signerOrProvider) as HooksFactory;
  }
}
