...
import {
  ...
  getLenderAccountsForAllMarketsList
} from "../../src/gql";
...
describe("legacy lender market discovery", () => {
  for (const getAccounts of [getLenderAccountsForAllMarkets, getLenderAccountsForAllMarketsList]) {
    it(`preserves hook credentials and known-market access on V2.0 schemas through ${getAccounts.name}`, async () => {
